              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.arguments =
                      new java.util.ArrayList<TSparkParameterValueArg>(_list256.size);
                  @org.apache.thrift.annotation.Nullable TSparkParameterValueArg _elem257;
                  for (int _i258 = 0; _i258 < _list256.size; ++_i258) {
                    _elem257 = new TSparkParameterValueArg();
                    _elem257.read(iprot);
                    struct.arguments.add(_elem257);
                  }
                  iprot.readListEnd();
                }
      ...
      if (struct.arguments != null) {
        if (struct.isSetArguments()) {
          oprot.writeFieldBegin(ARGUMENTS_FIELD_DESC);
          {
            ...
            for (TSparkParameterValueArg _iter259 : struct.arguments) {
  ...
  private static class TSparkParameterTupleScheme
      ...
      if (struct.isSetArguments()) {
        {
          ...
          for (TSparkParameterValueArg _iter260 : struct.arguments) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TSparkParameter struct)
      ...
      try {
        ...
        if (incoming.get(4)) {
          {
            org.apache.thrift.protocol.TList _list261 =
                iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
            struct.arguments = new java.util.ArrayList<TSparkParameterValueArg>(_list261.size);
            @org.apache.thrift.annotation.Nullable TSparkParameterValueArg _elem262;
            for (int _i263 = 0; _i263 < _list261.size; ++_i263) {
              _elem262 = new TSparkParameterValueArg();
              _elem262.read(iprot);
              struct.arguments.add(_elem262);
            }
          }
          struct.setArgumentsIsSet(true);
        }
