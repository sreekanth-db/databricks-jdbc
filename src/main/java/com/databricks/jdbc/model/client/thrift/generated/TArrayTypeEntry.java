...
@javax.annotation.Generated(
    ...
    date = "2026-08-03")
public class TArrayTypeEntry
    implements org.apache.thrift.TBase<TArrayTypeEntry, TArrayTypeEntry._Fields>,
        java.io.Serializable,
        Cloneable,
        Comparable<TArrayTypeEntry> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
      new org.apache.thrift.protocol.TStruct("TArrayTypeEntry");

  private static final org.apache.thrift.protocol.TField OBJECT_TYPE_PTR_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "objectTypePtr", org.apache.thrift.protocol.TType.I32, (short) 1);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
      new TArrayTypeEntryStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
      new TArrayTypeEntryTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
        TArrayTypeEntry.class, metaDataMap);
  }
  ...
  public void unsetObjectTypePtr() {
    __isset_bitfield =
        org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __OBJECTTYPEPTR_ISSET_ID);
  }
  ...
  public void setObjectTypePtrIsSet(boolean value) {
    __isset_bitfield =
        org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __OBJECTTYPEPTR_ISSET_ID, value);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TArrayTypeEntry) return this.equals((TArrayTypeEntry) that);
    return false;
  }
  ...
  public boolean equals(TArrayTypeEntry that) {
    ...
    if (this_present_objectTypePtr || that_present_objectTypePtr) {
      if (!(this_present_objectTypePtr && that_present_objectTypePtr)) return false;
      if (this.objectTypePtr != that.objectTypePtr) return false;
    }
  ...
  public int compareTo(TArrayTypeEntry other) {
    ...
    if (isSetObjectTypePtr()) {
      lastComparison =
          org.apache.thrift.TBaseHelper.compareTo(this.objectTypePtr, other.objectTypePtr);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'objectTypePtr' because it's a primitive and you chose the non-beans
    // generator.
  ...
  private static class TArrayTypeEntryStandardSchemeFactory
  ...
  private static class TArrayTypeEntryStandardScheme
      extends org.apache.thrift.scheme.StandardScheme<TArrayTypeEntry> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, TArrayTypeEntry struct)
        throws org.apache.thrift.TException {
      ...
      try {
        ...
        if (!struct.isSetObjectTypePtr()) {
          throw new org.apache.thrift.protocol.TProtocolException(
              "Required field 'objectTypePtr' was not found in serialized data! Struct: "
                  + toString());
        }
        struct.validate();
      } finally {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, TArrayTypeEntry struct)
        throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TArrayTypeEntryTupleSchemeFactory
      implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class TArrayTypeEntryTupleScheme
      extends org.apache.thrift.scheme.TupleScheme<TArrayTypeEntry> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TArrayTypeEntry struct)
        throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TArrayTypeEntry struct)
        throws org.apache.thrift.TException {
