              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.tableTypes = new java.util.ArrayList<java.lang.String>(_list264.size);
                  ...
                  for (int _i266 = 0; _i266 < _list264.size; ++_i266) {
                    ...
                    struct.tableTypes.add(_elem265);
                  }
                  iprot.readListEnd();
                }
      ...
      if (struct.tableTypes != null) {
        if (struct.isSetTableTypes()) {
          oprot.writeFieldBegin(TABLE_TYPES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter267 : struct.tableTypes) {
  ...
  private static class TGetTablesReqTupleScheme
      ...
      if (struct.isSetTableTypes()) {
        {
          ...
          for (java.lang.String _iter268 : struct.tableTypes) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TGetTablesReq struct)
      ...
      try {
        ...
        if (incoming.get(3)) {
          {
            org.apache.thrift.protocol.TList _list269 =
                iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
            struct.tableTypes = new java.util.ArrayList<java.lang.String>(_list269.size);
            ...
            for (int _i271 = 0; _i271 < _list269.size; ++_i271) {
              ...
              struct.tableTypes.add(_elem270);
            }
          }
          struct.setTableTypesIsSet(true);
        }
