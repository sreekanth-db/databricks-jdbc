...
public class TExecuteStatementReq
  ...
  private static final org.apache.thrift.protocol.TField BATCH_PARAMETERS_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "batchParameters", org.apache.thrift.protocol.TType.LIST, (short) 1297);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<TSparkParameter>>
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    BATCH_PARAMETERS((short) 1297, "batchParameters");
  ...
  public TExecuteStatementReq(TExecuteStatementReq other) {
    ...
    if (other.isSetBatchParameters()) {
      java.util.List<java.util.List<TSparkParameter>> __this__batchParameters =
          new java.util.ArrayList<java.util.List<TSparkParameter>>(other.batchParameters.size());
      for (java.util.List<TSparkParameter> other_element : other.batchParameters) {
        __this__batchParameters.add(new java.util.ArrayList<TSparkParameter>(other_element));
      }
      this.batchParameters = __this__batchParameters;
    }
  }
  ...
  public int getBatchParametersSize() {
    return (this.batchParameters == null) ? 0 : this.batchParameters.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.util.List<TSparkParameter>> getBatchParametersIterator() {
    return (this.batchParameters == null) ? null : this.batchParameters.iterator();
  }

  public void addToBatchParameters(java.util.List<TSparkParameter> elem) {
    if (this.batchParameters == null) {
      this.batchParameters = new java.util.ArrayList<java.util.List<TSparkParameter>>();
    }
    this.batchParameters.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.util.List<TSparkParameter>> getBatchParameters() {
    return this.batchParameters;
  }

  public TExecuteStatementReq setBatchParameters(
      @org.apache.thrift.annotation.Nullable
          java.util.List<java.util.List<TSparkParameter>> batchParameters) {
    this.batchParameters = batchParameters;
    return this;
  }

  public void unsetBatchParameters() {
    this.batchParameters = null;
  }

  /**
   * Returns true if field batchParameters is set (has been assigned a value) and false otherwise
   */
  public boolean isSetBatchParameters() {
    return this.batchParameters != null;
  }

  public void setBatchParametersIsSet(boolean value) {
    if (!value) {
      this.batchParameters = null;
    }
  }
  ...
  public void setFieldValue(
    ...
    switch (field) {
      ...
      case BATCH_PARAMETERS:
        if (value == null) {
          unsetBatchParameters();
        } else {
          setBatchParameters((java.util.List<java.util.List<TSparkParameter>>) value);
        }
        break;
    }
  }
  ...
  public boolean equals(TExecuteStatementReq that) {
    ...
    boolean this_present_batchParameters = true && this.isSetBatchParameters();
    boolean that_present_batchParameters = true && that.isSetBatchParameters();
    if (this_present_batchParameters || that_present_batchParameters) {
      if (!(this_present_batchParameters && that_present_batchParameters)) return false;
      if (!this.batchParameters.equals(that.batchParameters)) return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetBatchParameters()) ? 131071 : 524287);
    if (isSetBatchParameters()) hashCode = hashCode * 8191 + batchParameters.hashCode();
  ...
  public int compareTo(TExecuteStatementReq other) {
    ...
    lastComparison =
        java.lang.Boolean.compare(isSetBatchParameters(), other.isSetBatchParameters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBatchParameters()) {
      lastComparison =
          org.apache.thrift.TBaseHelper.compareTo(this.batchParameters, other.batchParameters);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetBatchParameters()) {
      if (!first) sb.append(", ");
      sb.append("batchParameters:");
      if (this.batchParameters == null) {
        sb.append("null");
      } else {
        sb.append(this.batchParameters);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class TExecuteStatementReqStandardScheme
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.batchParameters =
                      new java.util.ArrayList<java.util.List<TSparkParameter>>(_list221.size);
                  @org.apache.thrift.annotation.Nullable java.util.List<TSparkParameter> _elem222;
                  for (int _i223 = 0; _i223 < _list221.size; ++_i223) {
                    {
                      org.apache.thrift.protocol.TList _list224 = iprot.readListBegin();
                      _elem222 = new java.util.ArrayList<TSparkParameter>(_list224.size);
                      @org.apache.thrift.annotation.Nullable TSparkParameter _elem225;
                      for (int _i226 = 0; _i226 < _list224.size; ++_i226) {
                        _elem225 = new TSparkParameter();
                        _elem225.read(iprot);
                        _elem222.add(_elem225);
                      }
                      iprot.readListEnd();
                    }
                    struct.batchParameters.add(_elem222);
                  }
                  iprot.readListEnd();
                }
                struct.setBatchParametersIsSet(true);
              } else {
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TExecuteStatementReq struct)
      ...
      if (struct.confOverlay != null) {
        if (struct.isSetConfOverlay()) {
          oprot.writeFieldBegin(CONF_OVERLAY_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter227 :
      ...
      if (struct.parameters != null) {
        if (struct.isSetParameters()) {
          oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
          {
            ...
            for (TSparkParameter _iter228 : struct.parameters) {
      ...
      if (struct.batchParameters != null) {
        if (struct.isSetBatchParameters()) {
          oprot.writeFieldBegin(BATCH_PARAMETERS_FIELD_DESC);
          {
            oprot.writeListBegin(
                new org.apache.thrift.protocol.TList(
                    org.apache.thrift.protocol.TType.LIST, struct.batchParameters.size()));
            for (java.util.List<TSparkParameter> _iter229 : struct.batchParameters) {
              {
                oprot.writeListBegin(
                    new org.apache.thrift.protocol.TList(
                        org.apache.thrift.protocol.TType.STRUCT, _iter229.size()));
                for (TSparkParameter _iter230 : _iter229) {
  ...
  private static class TExecuteStatementReqTupleScheme
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TExecuteStatementReq struct)
      ...
      if (struct.isSetConfOverlay()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter231 :
              struct.confOverlay.entrySet()) {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (TSparkParameter _iter232 : struct.parameters) {
      ...
      if (struct.isSetBatchParameters()) {
        {
          oprot.writeI32(struct.batchParameters.size());
          for (java.util.List<TSparkParameter> _iter233 : struct.batchParameters) {
            {
              oprot.writeI32(_iter233.size());
              for (TSparkParameter _iter234 : _iter233) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TExecuteStatementReq struct)
      ...
      try {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TMap _map235 =
                iprot.readMapBegin(
                    org.apache.thrift.protocol.TType.STRING,
                    org.apache.thrift.protocol.TType.STRING);
            struct.confOverlay =
                new java.util.HashMap<java.lang.String, java.lang.String>(2 * _map235.size);
            ...
            for (int _i238 = 0; _i238 < _map235.size; ++_i238) {
              ...
              struct.confOverlay.put(_key236, _val237);
            }
          }
          struct.setConfOverlayIsSet(true);
        }
        ...
        if (incoming.get(10)) {
          {
            org.apache.thrift.protocol.TList _list239 =
                iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
            struct.parameters = new java.util.ArrayList<TSparkParameter>(_list239.size);
            @org.apache.thrift.annotation.Nullable TSparkParameter _elem240;
            for (int _i241 = 0; _i241 < _list239.size; ++_i241) {
              _elem240 = new TSparkParameter();
              _elem240.read(iprot);
              struct.parameters.add(_elem240);
            }
          }
          struct.setParametersIsSet(true);
        }
        ...
        if (incoming.get(13)) {
          {
            ...
            struct.batchParameters =
                new java.util.ArrayList<java.util.List<TSparkParameter>>(_list242.size);
            @org.apache.thrift.annotation.Nullable java.util.List<TSparkParameter> _elem243;
            for (int _i244 = 0; _i244 < _list242.size; ++_i244) {
              {
                org.apache.thrift.protocol.TList _list245 =
                    iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
                _elem243 = new java.util.ArrayList<TSparkParameter>(_list245.size);
                @org.apache.thrift.annotation.Nullable TSparkParameter _elem246;
                for (int _i247 = 0; _i247 < _list245.size; ++_i247) {
                  _elem246 = new TSparkParameter();
                  _elem246.read(iprot);
                  _elem243.add(_elem246);
                }
              }
              struct.batchParameters.add(_elem243);
            }
          }
          struct.setBatchParametersIsSet(true);
        }
