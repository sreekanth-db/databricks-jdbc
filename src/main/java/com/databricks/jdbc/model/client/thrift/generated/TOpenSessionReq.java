...
public class TOpenSessionReq
  ...
  public TOpenSessionReq() {
    this.client_protocol = TProtocolVersion.__HIVE_JDBC_WORKAROUND;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                for (int _i238 = 0; _i238 < _list236.size; ++_i238) {
                  _elem237 = TGetInfoType.findByValue(iprot.readI32());
                  if (_elem237 != null) {
      ...
      if (incoming.get(4)) {
        {
          ...
          for (int _i255 = 0; _i255 < _list253.size; ++_i255) {
            _elem254 = TGetInfoType.findByValue(iprot.readI32());
            if (_elem254 != null) {
