            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.arguments = new java.util.ArrayList<TSparkParameterValueArg>(_list296.size);
                @org.apache.thrift.annotation.Nullable TSparkParameterValueArg _elem297;
                for (int _i298 = 0; _i298 < _list296.size; ++_i298) {
                  _elem297 = new TSparkParameterValueArg();
                  _elem297.read(iprot);
                  struct.arguments.add(_elem297);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.arguments != null) {
        if (struct.isSetArguments()) {
          oprot.writeFieldBegin(ARGUMENTS_FIELD_DESC);
          {
            ...
            for (TSparkParameterValueArg _iter299 : struct.arguments) {
      ...
      if (struct.isSetArguments()) {
        {
          ...
          for (TSparkParameterValueArg _iter300 : struct.arguments) {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.arguments = new java.util.ArrayList<TSparkParameterValueArg>(_list301.size);
          @org.apache.thrift.annotation.Nullable TSparkParameterValueArg _elem302;
          for (int _i303 = 0; _i303 < _list301.size; ++_i303) {
            _elem302 = new TSparkParameterValueArg();
            _elem302.read(iprot);
            struct.arguments.add(_elem302);
          }
        }
        struct.setArgumentsIsSet(true);
      }
