              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.arguments =
                      new java.util.ArrayList<TSparkParameterValueArg>(_list248.size);
                  @org.apache.thrift.annotation.Nullable TSparkParameterValueArg _elem249;
                  for (int _i250 = 0; _i250 < _list248.size; ++_i250) {
                    _elem249 = new TSparkParameterValueArg();
                    _elem249.read(iprot);
                    struct.arguments.add(_elem249);
                  }
                  iprot.readListEnd();
                }
      ...
      if (struct.arguments != null) {
        if (struct.isSetArguments()) {
          oprot.writeFieldBegin(ARGUMENTS_FIELD_DESC);
          {
            ...
            for (TSparkParameterValueArg _iter251 : struct.arguments) {
      ...
      if (struct.isSetArguments()) {
        {
          ...
          for (TSparkParameterValueArg _iter252 : struct.arguments) {
        ...
        if (incoming.get(2)) {
          {
            ...
            struct.arguments = new java.util.ArrayList<TSparkParameterValueArg>(_list253.size);
            @org.apache.thrift.annotation.Nullable TSparkParameterValueArg _elem254;
            for (int _i255 = 0; _i255 < _list253.size; ++_i255) {
              _elem254 = new TSparkParameterValueArg();
              _elem254.read(iprot);
              struct.arguments.add(_elem254);
            }
          }
          struct.setArgumentsIsSet(true);
        }
