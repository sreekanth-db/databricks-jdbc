      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumn _iter151 : struct.columns) {
      ...
      if (struct.arrowBatches != null) {
        if (struct.isSetArrowBatches()) {
          oprot.writeFieldBegin(ARROW_BATCHES_FIELD_DESC);
          {
            ...
            for (TSparkArrowBatch _iter152 : struct.arrowBatches) {
      ...
      if (struct.resultLinks != null) {
        if (struct.isSetResultLinks()) {
          oprot.writeFieldBegin(RESULT_LINKS_FIELD_DESC);
          {
            ...
            for (TSparkArrowResultLink _iter153 : struct.resultLinks) {
  ...
  private static class TRowSetTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRowSet> {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (TColumn _iter155 : struct.columns) {
      ...
      if (struct.isSetArrowBatches()) {
        {
          ...
          for (TSparkArrowBatch _iter156 : struct.arrowBatches) {
      ...
      if (struct.isSetResultLinks()) {
        {
          ...
          for (TSparkArrowResultLink _iter157 : struct.resultLinks) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRowSet struct)
      ...
      struct.setStartRowOffsetIsSet(true);
      {
        ...
        struct.rows = new java.util.ArrayList<TRow>(_list158.size);
        @org.apache.thrift.annotation.Nullable TRow _elem159;
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list161 =
              iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.columns = new java.util.ArrayList<TColumn>(_list161.size);
          @org.apache.thrift.annotation.Nullable TColumn _elem162;
          for (int _i163 = 0; _i163 < _list161.size; ++_i163) {
            _elem162 = new TColumn();
            _elem162.read(iprot);
            struct.columns.add(_elem162);
          }
        }
        struct.setColumnsIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list164 =
              iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.arrowBatches = new java.util.ArrayList<TSparkArrowBatch>(_list164.size);
          @org.apache.thrift.annotation.Nullable TSparkArrowBatch _elem165;
          for (int _i166 = 0; _i166 < _list164.size; ++_i166) {
            _elem165 = new TSparkArrowBatch();
            _elem165.read(iprot);
            struct.arrowBatches.add(_elem165);
          }
        }
        struct.setArrowBatchesIsSet(true);
      }
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list167 =
              iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.resultLinks = new java.util.ArrayList<TSparkArrowResultLink>(_list167.size);
          @org.apache.thrift.annotation.Nullable TSparkArrowResultLink _elem168;
          for (int _i169 = 0; _i169 < _list167.size; ++_i169) {
            _elem168 = new TSparkArrowResultLink();
            _elem168.read(iprot);
            struct.resultLinks.add(_elem168);
          }
        }
        struct.setResultLinksIsSet(true);
      }
