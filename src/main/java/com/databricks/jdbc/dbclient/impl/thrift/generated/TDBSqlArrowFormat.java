...
@javax.annotation.Generated(
    ...
    date = "2024-05-06")
public class TDBSqlArrowFormat
    implements org.apache.thrift.TBase<TDBSqlArrowFormat, TDBSqlArrowFormat._Fields>,
        java.io.Serializable,
        Cloneable,
        Comparable<TDBSqlArrowFormat> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
      new org.apache.thrift.protocol.TStruct("TDBSqlArrowFormat");

  private static final org.apache.thrift.protocol.TField ARROW_LAYOUT_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "arrowLayout", org.apache.thrift.protocol.TType.I32, (short) 1);
  private static final org.apache.thrift.protocol.TField COMPRESSION_CODEC_FIELD_DESC =
      new org.apache.thrift.protocol.TField(
          "compressionCodec", org.apache.thrift.protocol.TType.I32, (short) 2);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
      new TDBSqlArrowFormatStandardSchemeFactory();
  ...
  static {
    ...
    tmpMap.put(
        _Fields.ARROW_LAYOUT,
        new org.apache.thrift.meta_data.FieldMetaData(
            "arrowLayout",
            org.apache.thrift.TFieldRequirementType.OPTIONAL,
            new org.apache.thrift.meta_data.EnumMetaData(
                org.apache.thrift.protocol.TType.ENUM, TDBSqlArrowLayout.class)));
    tmpMap.put(
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
        TDBSqlArrowFormat.class, metaDataMap);
  }

  public TDBSqlArrowFormat() {}

  /** Performs a deep copy on <i>other</i>. */
  public TDBSqlArrowFormat(TDBSqlArrowFormat other) {
    if (other.isSetArrowLayout()) {
      this.arrowLayout = other.arrowLayout;
    }
  ...
  @Override
  public TDBSqlArrowFormat deepCopy() {
  ...
  public void setArrowLayoutIsSet(boolean value) {
    if (!value) {
      this.arrowLayout = null;
    }
  }
    ...
    switch (field) {
      case ARROW_LAYOUT:
        if (value == null) {
          ...
          setArrowLayout((TDBSqlArrowLayout) value);
        }
        break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TDBSqlArrowFormat) return this.equals((TDBSqlArrowFormat) that);
    return false;
  }

  public boolean equals(TDBSqlArrowFormat that) {
    if (that == null) return false;
    if (this == that) return true;

    boolean this_present_arrowLayout = true && this.isSetArrowLayout();
    boolean that_present_arrowLayout = true && that.isSetArrowLayout();
    if (this_present_arrowLayout || that_present_arrowLayout) {
      if (!(this_present_arrowLayout && that_present_arrowLayout)) return false;
      if (!this.arrowLayout.equals(that.arrowLayout)) return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetArrowLayout()) ? 131071 : 524287);
    if (isSetArrowLayout()) hashCode = hashCode * 8191 + arrowLayout.getValue();
  ...
  @Override
  public int compareTo(TDBSqlArrowFormat other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetArrowLayout(), other.isSetArrowLayout());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetArrowLayout()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.arrowLayout, other.arrowLayout);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDBSqlArrowFormat(");
    boolean first = true;
  ...
  private static class TDBSqlArrowFormatStandardSchemeFactory
      implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TDBSqlArrowFormatStandardScheme getScheme() {
      return new TDBSqlArrowFormatStandardScheme();
    }
  }

  private static class TDBSqlArrowFormatStandardScheme
      extends org.apache.thrift.scheme.StandardScheme<TDBSqlArrowFormat> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, TDBSqlArrowFormat struct)
        throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // ARROW_LAYOUT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.arrowLayout =
                  com.databricks.jdbc.dbclient.impl.thrift.generated.TDBSqlArrowLayout.findByValue(
                      iprot.readI32());
              struct.setArrowLayoutIsSet(true);
            } else {
          ...
          case 2: // COMPRESSION_CODEC
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.compressionCodec =
                  com.databricks.jdbc.dbclient.impl.thrift.generated.TDBSqlCompressionCodec
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDBSqlArrowFormat struct)
        throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.arrowLayout != null) {
        if (struct.isSetArrowLayout()) {
          oprot.writeFieldBegin(ARROW_LAYOUT_FIELD_DESC);
          oprot.writeI32(struct.arrowLayout.getValue());
          oprot.writeFieldEnd();
        }
      }
  ...
  private static class TDBSqlArrowFormatTupleSchemeFactory
      implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TDBSqlArrowFormatTupleScheme getScheme() {
      return new TDBSqlArrowFormatTupleScheme();
    }
  }

  private static class TDBSqlArrowFormatTupleScheme
      extends org.apache.thrift.scheme.TupleScheme<TDBSqlArrowFormat> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDBSqlArrowFormat struct)
        throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDBSqlArrowFormat struct)
        throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        struct.compressionCodec =
            com.databricks.jdbc.dbclient.impl.thrift.generated.TDBSqlCompressionCodec.findByValue(
                iprot.readI32());
        struct.setCompressionCodecIsSet(true);
      }
    }
