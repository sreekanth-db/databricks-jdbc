...
public class TGetTablesReq
  ...
  public TGetTablesReq setOperationId(
  ...
  public TGetTablesReq setSessionConf(
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tableTypes = new java.util.ArrayList<java.lang.String>(_list312.size);
                ...
                for (int _i314 = 0; _i314 < _list312.size; ++_i314) {
                  ...
                  struct.tableTypes.add(_elem313);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tableTypes != null) {
        if (struct.isSetTableTypes()) {
          oprot.writeFieldBegin(TABLE_TYPES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter315 : struct.tableTypes) {
  ...
  private static class TGetTablesReqTupleScheme
      ...
      if (struct.isSetTableTypes()) {
        {
          ...
          for (java.lang.String _iter316 : struct.tableTypes) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TGetTablesReq struct)
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list317 =
              iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.tableTypes = new java.util.ArrayList<java.lang.String>(_list317.size);
          ...
          for (int _i319 = 0; _i319 < _list317.size; ++_i319) {
            ...
            struct.tableTypes.add(_elem318);
          }
        }
        struct.setTableTypesIsSet(true);
      }
