            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tableTypes = new java.util.ArrayList<java.lang.String>(_list296.size);
                ...
                for (int _i298 = 0; _i298 < _list296.size; ++_i298) {
                  ...
                  struct.tableTypes.add(_elem297);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tableTypes != null) {
        if (struct.isSetTableTypes()) {
          oprot.writeFieldBegin(TABLE_TYPES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter299 : struct.tableTypes) {
      ...
      if (struct.isSetTableTypes()) {
        {
          ...
          for (java.lang.String _iter300 : struct.tableTypes) {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.tableTypes = new java.util.ArrayList<java.lang.String>(_list301.size);
          ...
          for (int _i303 = 0; _i303 < _list301.size; ++_i303) {
            ...
            struct.tableTypes.add(_elem302);
          }
        }
        struct.setTableTypesIsSet(true);
      }
