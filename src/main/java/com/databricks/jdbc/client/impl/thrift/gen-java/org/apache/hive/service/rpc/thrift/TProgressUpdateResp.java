        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.headerNames = new java.util.ArrayList<java.lang.String>(_list328.size);
                ...
                for (int _i330 = 0; _i330 < _list328.size; ++_i330) {
                  ...
                  struct.headerNames.add(_elem329);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rows =
                    new java.util.ArrayList<java.util.List<java.lang.String>>(_list331.size);
                @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> _elem332;
                for (int _i333 = 0; _i333 < _list331.size; ++_i333) {
                  {
                    org.apache.thrift.protocol.TList _list334 = iprot.readListBegin();
                    _elem332 = new java.util.ArrayList<java.lang.String>(_list334.size);
                    ...
                    for (int _i336 = 0; _i336 < _list334.size; ++_i336) {
                      ...
                      _elem332.add(_elem335);
                    }
                    iprot.readListEnd();
                  }
                  struct.rows.add(_elem332);
                }
                iprot.readListEnd();
              }
          ...
          case 4: // STATUS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.status =
                  org.apache.hive.service.rpc.thrift.TJobExecutionStatus.findByValue(
                      iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TProgressUpdateResp struct)
      ...
      if (struct.headerNames != null) {
        oprot.writeFieldBegin(HEADER_NAMES_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter337 : struct.headerNames) {
      ...
      if (struct.rows != null) {
        oprot.writeFieldBegin(ROWS_FIELD_DESC);
        {
          ...
          for (java.util.List<java.lang.String> _iter338 : struct.rows) {
            {
              oprot.writeListBegin(
                  new org.apache.thrift.protocol.TList(
                      org.apache.thrift.protocol.TType.STRING, _iter338.size()));
              for (java.lang.String _iter339 : _iter338) {
  ...
  private static class TProgressUpdateRespTupleScheme
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TProgressUpdateResp struct)
          ...
          (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (java.lang.String _iter340 : struct.headerNames) {
          oprot.writeString(_iter340);
        }
      }
      {
        oprot.writeI32(struct.rows.size());
        for (java.util.List<java.lang.String> _iter341 : struct.rows) {
          {
            oprot.writeI32(_iter341.size());
            for (java.lang.String _iter342 : _iter341) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TProgressUpdateResp struct)
      ...
      org.apache.thrift.protocol.TTupleProtocol iprot =
          (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        org.apache.thrift.protocol.TList _list343 =
            iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
        struct.headerNames = new java.util.ArrayList<java.lang.String>(_list343.size);
        ...
        for (int _i345 = 0; _i345 < _list343.size; ++_i345) {
          ...
          struct.headerNames.add(_elem344);
        }
      }
      struct.setHeaderNamesIsSet(true);
      {
        org.apache.thrift.protocol.TList _list346 =
            iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.rows = new java.util.ArrayList<java.util.List<java.lang.String>>(_list346.size);
        @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> _elem347;
        for (int _i348 = 0; _i348 < _list346.size; ++_i348) {
          {
            org.apache.thrift.protocol.TList _list349 =
                iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
            _elem347 = new java.util.ArrayList<java.lang.String>(_list349.size);
            @org.apache.thrift.annotation.Nullable java.lang.String _elem350;
            for (int _i351 = 0; _i351 < _list349.size; ++_i351) {
              _elem350 = iprot.readString();
              _elem347.add(_elem350);
            }
          }
          struct.rows.add(_elem347);
        }
      }
      struct.setRowsIsSet(true);
      struct.progressedPercentage = iprot.readDouble();
      struct.setProgressedPercentageIsSet(true);
      struct.status =
          org.apache.hive.service.rpc.thrift.TJobExecutionStatus.findByValue(iprot.readI32());
      struct.setStatusIsSet(true);
      struct.footerSummary = iprot.readString();
      struct.setFooterSummaryIsSet(true);
      struct.startTime = iprot.readI64();
