...
public final class DatabricksJdbcConstants {
  ...
  public static final Pattern EXPLAIN_PATTERN =
      Pattern.compile("^\\s*EXPLAIN", Pattern.CASE_INSENSITIVE);
  ...
  public static final Pattern VALUES_PATTERN =
      Pattern.compile("^\\s*VALUES", Pattern.CASE_INSENSITIVE);
  ...
  public static final Pattern SUBQUERY_PATTERN =
      Pattern.compile("^\\s*\\(", Pattern.CASE_INSENSITIVE);
  public static final Pattern DECLARE_PATTERN =
      Pattern.compile("^\\s*DECLARE", Pattern.CASE_INSENSITIVE);
