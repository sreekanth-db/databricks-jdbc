 ...
 *
 * <p>Each {@link com.comparator.config.TestSuite} enum constant maps to one SuiteProvider
 * implementation. The provider is responsible for creating and closing any JDBC resources
 * (Statements, ResultSets) within {@link #execute}. Connections are managed externally and must NOT
